...
if torch.cuda.is_available():
    ...
    batch = 32  # Larger batch for dedicated GPU
    workers = 8
...
# n=nano (3M params), s=small (11M params), m=medium (25M params), l=large (43M params), x=xlarge (68M params)
model = YOLO('yolov8s.pt')  # Small model - 11M params, great balance
